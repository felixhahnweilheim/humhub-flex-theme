...
class ColorSettings extends \yii\base\Model
{
    ...
    // Text Colors
    const TEXT_COLORS = array('text_color_main', 'text_color_secondary', 'text_color_highlight', 'text_color_soft', 'text_color_soft2', 'text_color_soft3', 'text_color_contrast');
    ...
    public static function getColors() {
		...
		$colors = array_merge(self::MAIN_COLORS, self::TEXT_COLORS, self::SPECIAL_COLORS);
    ...
    public function init() {
        ...
        foreach(self::TEXT_COLORS as $color) {
    ...
    public function attributeHints()
    {
        ...
        $colors = array_merge(self::MAIN_COLORS, self::TEXT_COLORS);
        $base_theme = ThemeHelper::getThemeByName('HumHub');
    ...
    public function rules() {
        ...
        return [
            [['default', 'primary', 'info', 'link', 'success', 'warning', 'danger', 'text_color_main', 'text_color_secondary', 'text_color_highlight', 'text_color_soft', 'text_color_soft2', 'text_color_soft3', 'text_color_contrast'], 'validateHexColor']
        ];
    }
